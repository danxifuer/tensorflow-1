...
inline ::google::protobuf::uint32* protobuf_Offsets_tensorflow_2fcore_2fframework_2ftypes_2eproto() { return NULL; }
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorflow/core/framework/types.proto", schemas, file_default_instances, protobuf_Offsets_tensorflow_2fcore_2fframework_2ftypes_2eproto(), factory,
...
void protobuf_InitDefaults_tensorflow_2fcore_2fframework_2ftypes_2eproto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &protobuf_InitDefaults_tensorflow_2fcore_2fframework_2ftypes_2eproto_impl);
}
