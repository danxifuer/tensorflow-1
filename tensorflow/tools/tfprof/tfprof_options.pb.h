...
class OptionsProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.OptionsProto) */ {
 ...
 private:
  ...
  bool viz_;
  friend void  protobuf_InitDefaults_tensorflow_2ftools_2ftfprof_2ftfprof_5foptions_2eproto_impl();
  friend void  protobuf_AddDesc_tensorflow_2ftools_2ftfprof_2ftfprof_5foptions_2eproto_impl();
  friend const ::google::protobuf::uint32* protobuf_Offsets_tensorflow_2ftools_2ftfprof_2ftfprof_5foptions_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_2ftools_2ftfprof_2ftfprof_5foptions_2eproto();
